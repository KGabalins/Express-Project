...
export const updateUserEmailHandler = async (req: Request<{}, {}, UpdateUserEmailInput["body"]>, res: Response) => {
  // @ts-ignore
...
export const updateUserPasswordHandler = async (req: Request<{}, {}, UpdateUserPasswordInput["body"]>, res: Response) => {
